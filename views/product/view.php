...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="/Phpshop/templatejs/html5shiv.js"></script>
    <script src="/Phpshop/templatejs/respond.min.js"></script>
    <![endif]-->
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/Phpshop/template/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/Phpshop/template/images/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="/Phpshop/template/images/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="/Phpshop/template/#"><i class="fa fa-phone"></i> +38 093 000 11 22</a></li>
                            <li><a href="/Phpshop/template/#"><i class="fa fa-envelope"></i> zinchenko.us@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="/Phpshop/template/#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="/Phpshop/template/#"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="/Phpshop/template/index.html"><img src="/Phpshop/template/images/home/logo.png" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="/Phpshop/template/#"><i class="fa fa-shopping-cart"></i> Корзина</a></li>
                            <li><a href="/Phpshop/template/#"><i class="fa fa-user"></i> Аккаунт</a></li>
                            <li><a href="/Phpshop/template/#"><i class="fa fa-lock"></i> Вход</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="/Phpshop/template/#" class="active">Главная</a></li>
                            <li class="dropdown"><a href="/Phpshop/template/#">Магазин<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/Phpshop/template/#">Каталог товаров</a></li>
                                    <li><a href="/Phpshop/template/#">Корзина</a></li>
                                </ul>
                            </li>
                            <li><a href="/Phpshop/template/#">Блог</a></li>
                            <li><a href="/Phpshop/template/#">О магазине</a></li>
                            <li><a href="/Phpshop/template/#">Контакты</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="/Phpshop/template/#">Категория</a></h4>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="view-product">
                                <img src="/Phpshop/template/images/product-details/1.jpg" alt="" />
                            </div>
                        </div>
                        <div class="col-sm-7">
